...
const EbayOrderSyncStatusAction = props => {
    ...
    return (
      <div className={classes.divWrapper}>
        <Paper elevation={6} variant="elevation" className={classes.paper}>
          <img src={EbayLogo} className={classes.logo} alt="Amazon Logo" />

          <p>Checking your Ebay orders...</p>
          <div className={classes.startedAt}>
            <ScheduleIcon style={{ fontSize: '20px', marginRight: '5px' }} />
            <p style={{ fontSize: '16px', fontWeight: 900, textTransform: 'uppercase' }}>Started at: {props.ebayOrderSyncStatus.started_at}</p>
          </div>
        </Paper>
...
export default connect(mapStateToProps)(EbayOrderSyncStatusAction);
